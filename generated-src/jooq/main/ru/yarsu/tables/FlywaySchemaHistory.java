...
import ru.yarsu.Indexes;
import ru.yarsu.Keys;
...
public class FlywaySchemaHistory extends TableImpl<FlywaySchemaHistoryRecord> {
     ...
     */
    public final TableField<FlywaySchemaHistoryRecord, LocalDateTime> INSTALLED_ON = createField(DSL.name("installed_on"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");
