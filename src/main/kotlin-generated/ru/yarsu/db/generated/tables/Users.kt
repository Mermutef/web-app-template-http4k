...
open class Users(
    ...
    /**
     * The column <code>public.users.fcs</code>.
     */
    val FCS: TableField<UsersRecord, String?> = createField(DSL.name("fcs"), SQLDataType.CLOB.nullable(false), this, "")

    /**
     * The column <code>public.users.degree</code>.
     */
    val DEGREE: TableField<UsersRecord, Array<Int?>?> = createField(DSL.name("degree"), SQLDataType.INTEGER.array(), this, "")

    /**
     * The column <code>public.users.phone</code>.
     */
    val PHONE: TableField<UsersRecord, String?> = createField(DSL.name("phone"), SQLDataType.CLOB.nullable(false), this, "")

    /**
     * The column <code>public.users.vkid</code>.
     */
    val VKID: TableField<UsersRecord, String?> = createField(DSL.name("vkid"), SQLDataType.CLOB.nullable(false), this, "")

    /**
     * The column <code>public.users.login</code>.
     */
    val LOGIN: TableField<UsersRecord, String?> = createField(DSL.name("login"), SQLDataType.CLOB.nullable(false), this, "")

    /**
     * The column <code>public.users.password</code>.
     */
    val PASSWORD: TableField<UsersRecord, ByteArray?> = createField(DSL.name("password"), SQLDataType.BLOB.nullable(false), this, "")

    /**
     * The column <code>public.users.registerdate</code>.
     */
    val REGISTERDATE: TableField<UsersRecord, LocalDateTime?> =
        createField(DSL.name("registerdate"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "")

    /**
     * The column <code>public.users.permissions</code>.
     */
    val PERMISSIONS: TableField<UsersRecord, Int?> = createField(DSL.name("permissions"), SQLDataType.INTEGER.nullable(false), this, "")
    ...
    override fun getUniqueKeys(): List<UniqueKey<UsersRecord>> = listOf(USERS_LOGIN_KEY)
    ...
    ): Users = where(DSL.condition(condition))
    ...
    @PlainSQL override fun where(
        @Stringly.SQL condition: String,
        vararg binds: Any?,
    ): Users = where(DSL.condition(condition, *binds))
    ...
    ): Users = where(DSL.condition(condition, *parts))
